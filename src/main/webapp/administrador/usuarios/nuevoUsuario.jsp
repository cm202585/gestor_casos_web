...
<div class="container">
    ...
    <div class="col-md-7">
        <form role="form" action="${pageContext.request.contextPath}/AdministradorController?op=insertarusuario" method="POST">
            <div class="form-group">
                <label for="codigoUsuario">Código del usuario <i class="glyphicon glyphicon-barcode"></i>:</label>
                <input type="text" class="form-control" name="codigoUsuario"  id="codigoUsuario" placeholder="Ingresa el código del usuario">
            </div>

            <div class="form-group">
                <label for="nombreUsuario">Nombre del usuario <i class="glyphicon glyphicon-user"></i>:</label>
                <input type="text" class="form-control" name="nombreUsuario"  id="nombreUsuario" placeholder="Ingresa el nombre del usuario">
            </div>

            <div class="form-group">
                <label for="apellidoUsuario">Apellido del usuario <i class="glyphicon glyphicon-user"></i>:</label>
                <input type="text" class="form-control" name="apellidoUsuario"  id="apellidoUsuario" placeholder="Ingresa el apellido del usuario">
            </div>

            <div class="form-group">
                <label for="telefonoUsuario">Teléfono del usuario <i class="glyphicon glyphicon-phone"></i>:</label>
                <input type="text" class="form-control" name="telefonoUsuario"  id="telefonoUsuario" placeholder="Ingresa el teléfono del usuario">
            </div>

            <div class="form-group">
                <label for="correoUsuario">Correo del usuario <i class="glyphicon glyphicon-envelope"></i>:</label>
                <input type="email" class="form-control" name="correoUsuario"  id="correoUsuario" placeholder="Ingresa el correo del usuario">
            </div>

            <div class="form-group">
                <label for="duiUsuario">DUI <i class="glyphicon glyphicon-credit-card"></i>:</label>
                <input type="text" class="form-control" name="duiUsuario"  id="duiUsuario" placeholder="Ingresa el DUI del usuario">
            </div>

            <div class="form-group">
                <label for="contraseniaUsuario">Contraseña del usuario <i class="glyphicon glyphicon-lock"></i>:</label>
                <input type="password" class="form-control" name="contraseniaUsuario"  id="contraseniaUsuario" placeholder="Ingresa la contraseña del usuario">
            </div>
