...
<html>
<head lang="es">
    <title>Casos por desrrollar</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped table-bordered table-hover" id="tabla">
                    ...
                    <tbody>
                    <c:forEach items="${requestScope.casosPendientes}" var="casos">
                        <tr>
                                ...
                                <div class="btn-group" role="group">
                                    <c:choose>
                                        <c:when test="${casos.estadoBeans.estadoCaso != 'Esperando aprobación de area solicitante'}">
                                            ...
                                            <a title="finalizar" class="btn btn-primary" onclick="finalizar('${casos.idCasos}')">
                                    ...
                                    <a class="btn btn-primary" title="Ver Bitácora" href="${pageContext.request.contextPath}/ProgramadorController?op=verbitacoras&id=${casos.idCasos}">
